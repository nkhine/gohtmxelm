...
[`demo/elm/AppA.elm`](https://github.com/nkhine/gohtmxelm/blob/main/demo/elm/AppA.elm) is a message editor. A draft can be empty, too
...
[`demo/elm/LapStats.elm`](https://github.com/nkhine/gohtmxelm/blob/main/demo/elm/LapStats.elm) computes fastest/slowest/average lap
...
a well-typed value or a typed error. From [`demo/elm/BrokerPort.elm`](https://github.com/nkhine/gohtmxelm/blob/main/elm/BrokerPort.elm):
...
([`runtime/gohtmxelm-broker.js`](https://github.com/nkhine/gohtmxelm/blob/main/runtime/gohtmxelm-broker.js)) which calls `Elm.AppA.init({ node, flags })`.
